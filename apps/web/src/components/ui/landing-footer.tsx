	...
	return (
		<section className={cn("relative w-full overflow-hidden", className)}>
			<footer className="relative border-t border-border bg-background">
				...
				<div className="relative mx-auto flex min-h-[32rem] max-w-5xl flex-col justify-between px-6 py-14 sm:min-h-[36rem] md:min-h-[40rem]">
					...
					<div className="flex flex-col items-center gap-6">
						...
						<p className="max-w-sm text-center font-light text-muted-foreground text-sm leading-relaxed">
							Crowd-controlled music for venues. Let your guests vote on what plays
							next — no app required.
						</p>
					...
					{/* Bottom: copyright */}
					<div className="mt-16 flex flex-col items-center justify-between gap-2 md:flex-row md:mt-20">
						...
						<p className="text-center text-muted-foreground/50 text-xs md:text-right">
							Made with{" "}
							<span className="text-primary">♥</span> by Rohan Salunkhe
						</p>
					</div>
				</div>
				...
				<div
					aria-hidden="true"
					className="pointer-events-none absolute bottom-36 left-1/2 -translate-x-1/2 select-none text-center font-extrabold tracking-tighter leading-none"
					style={{
